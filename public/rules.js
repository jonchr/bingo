...
var rules = [
"You may not inform Jared about the game until the game is over.",
...
"All squares are universal to everyone (i.e. if one person can mark a square, everyone else can).",
"It is good sportsmanship (but not required) to notify others of an event.",
"Squares only need match the spirit of the quote rather than being exact.",
